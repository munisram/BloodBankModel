...
<form action="Register" method="post">
        ...
        <div class="formcontrol" >
            ...
            <input type="text" id="name" name="firstname" required autofocus placeholder="First Name"pattern="[A-Za-z]{3,}" title="mininum 3 character">
                </div><div class="formcontrol" >
            <input type="text" id="lastName" name="lastName" required placeholder="lastName" pattern="[A-Za-z]{3,}" title="mininum 3 character">
           ...
           <input type="text" id="ADHARCARD" name="ADHARCARD" required pattern="[123456789][0-9]{11}" placeholder="Aadharcard Number"  title="enter the valid Aadharcard number">
           </div><div class="formcontrol" > 
